        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_Tickets_TicketID",
                        column: x => x.TicketID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TreatmentPlanHospital", x => new { x.TreatmentPlanID, x.HospitalID });
                    table.ForeignKey(
                        name: "FK_TreatmentPlanHospital_Hospitals_HospitalID",
                        column: x => x.HospitalID,
                        principalTable: "Hospitals",
                        principalColumn: "HospitalID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TreatmentPlanHospital_TreatmentPlans_TreatmentPlanID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerRequests_Patients_PatientID",
                        column: x => x.PatientID,
                        principalTable: "Patients",
                        principalColumn: "PatientID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GuidPatientID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GuidID = table.Column<int>(type: "int", nullable: false),
                    PatientID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuidPatients", x => x.GuidPatientID);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GuidPatients_Patients_PatientID",
                        column: x => x.PatientID,
                        principalTable: "Patients",
                        principalColumn: "PatientID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerRequests_PatientID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GuidPatients_GuidID",
                table: "GuidPatients",
                column: "GuidID");

            migrationBuilder.CreateIndex(
                name: "IX_GuidPatients_PatientID",
                table: "GuidPatients",
                column: "PatientID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentPlanHospital_HospitalID",
                table: "TreatmentPlanHospital",
                column: "HospitalID");
